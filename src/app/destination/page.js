...
function destination() {
  return (
    ...
    bg-[url('/destination/background-destination-mobile.jpg')] bg-cover bg-no-repeat">
      ...
      <Image src='/destination/image-moon.png' width={170} height={170} 
      ...
      <div className='text-center pb-[32px] md:pb-[48px] 
        mx-[24px] md:mx-[28px] border-b border-[#383B4B] md:gap-[30px]'>
        <h1 className='font-belfair text-[56px] mt-[30px] md:text-[80px]'>MOON</h1>
