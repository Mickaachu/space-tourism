...
export default function GetInfo({destination}) {
    ...
    return(
        <div className="w-screen flex justify-around items-center" ref={scope} >
            <div  >
                <div className='flex justify-center items-center
                md:justify-start md:pl-[38px] w-full '>
                <motion.p variants={animation("x")} animate="visible" initial="hidden" transition={transistion(0.5, 2)} className='font-barlow-condensed tracking-[2.7px] lg:text-[28px]'><span className='pr-[18px] font-bold opacity-[0.25]'>01</span> PICK YOUR DESTINATION</motion.p>
                </div>
                <motion.div  variants={animation("x")} animate="visible" initial="hidden" transition={transistion(0.5, 2)}  className="planetImage relative w-[170px] sm:w-[300px]
